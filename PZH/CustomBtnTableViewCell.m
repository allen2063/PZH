...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [self.guideBtn setBackgroundImage:[UIImage imageNamed:@"bjan_dj" ] forState:UIControlStateSelected];
        ...
        self.commonProblemsBtn.frame = CGRectMake(15+10+BTNWIDTH*2, self.frame.size.height/3, BTNWIDTH, BTNHEIGHT);
        ...
        [self.commonProblemsBtn setBackgroundImage:[UIImage imageNamed:@"bjan_dj" ] forState:UIControlStateHighlighted];
        ...
        self.formDownloadBtn.frame =CGRectMake(15+5+BTNWIDTH, self.frame.size.height/3, BTNWIDTH, BTNHEIGHT);
        ...
        [self.formDownloadBtn setBackgroundImage:[UIImage imageNamed:@"bjan_dj" ] forState:UIControlStateHighlighted];
...
//        [self addSubview:self.consultingAndComplaint];
        ...
        self.policiesAndRegulationsBtn.frame = CGRectMake(15, self.frame.size.height*2/3, BTNWIDTH, BTNHEIGHT);
        ...
        [self.policiesAndRegulationsBtn setBackgroundImage:[UIImage imageNamed:@"bjan_dj" ] forState:UIControlStateHighlighted];
